...
class LlamaMLP(nn.Module):
    ...
    def forward(self, x):
        ...
        if q_len > self.pretraining_tp:
            chunk_size = math.ceil(q_len / self.pretraining_tp)
...
class LlamaForCausalLM(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        #     if hasattr(labels, 'mini'):
        #         if hasattr(labels, 'end'):
        ...
        #     print(shift_logits.shape, shift_labels.shape, loss_fct)
